<section id="home-section" class="hero" style="background-color:white;"
	data-stellar-background-ratio="0.5">
	<div class="home-slider owl-carousel">
		<div class="slider-item js-fullheight">
			<div class="overlay"></div>
			<div class="container-fluid p-0">
				<div class="row d-md-flex no-gutters slider-text align-items-end justify-content-center"
					data-scrollax-parent="true">
					<img class="one-fourt align order-md-last img-fluid" src="https://images.pexels.com/photos/1449053/pexels-photo-1449053.jpeg?cs=srgb&dl=adult-aroma-aromatherapy-1449053.jpg&fm=jpg" alt="">
